...
export default function SignaturePage() {
    const category = "Signature Products";
    ...
    const subCategories = [
        ...
        "Wood-Inspired Lifestyle Accessories",
        "Custom Branding Essentials"
    ]
    const imageUrl = "https://firebasestorage.googleapis.com/v0/b/wood-crest.firebasestorage.app/o/products%2FStatement%20Furniture%20Pieces%2F48ad250d-c983-4102-b0c5-651069501937-executive%20desk.jpg?alt=media&token=e493b912-510a-4f2c-bf97-a6f54bbf71a9"
    ...
    return (
        <div className="w-full">
            ...
            <div className="md:flex lg:gap-4 md:gap-2 items-start justify-center px-4 mb-8">
                ...
                <div className="w-full">
                    <ProductList user="customer" categoryFilter={category} sortBy={sortBy} subCategoryFilter={checkedSubCategories} priceRange={priceRange} />
                </div>
            </div>
